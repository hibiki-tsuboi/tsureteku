...
enum ObjectCaptureThumbnailService {
    ...
    nonisolated static func makeThumbnailImages(fromCaptureDirectory directoryURL: URL) -> (source: UIImage, cutout: UIImage)? {
    ...
    private nonisolated static func representativePhotoURL(in directoryURL: URL) -> URL? {
